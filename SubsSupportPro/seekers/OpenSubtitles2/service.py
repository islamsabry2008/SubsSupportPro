...
def download_subtitles(subtitles_list, pos, zip_subs, tmp_sub_dir, sub_folder, session_id, session=None):
    ...
    print('file_id_down: {}'.format(file_id))
    url = '{}/download'.format(BASE_URL)
    ...
    try:
        ...
        log(__name__, 'Error downloading subtitle: {}'.format(e))
        return None
...
def get_subtitles_list_movie(searchstring, languageshort, languagelong, subtitles_list):
    ...
    print('params_listmovies: {}'.format(params))
    ...
    try:
        ...
        for subtitle in data.get("data", []):
            ...
            subtitles_list.append({
                ...
                "sync": True,
                "id": file_id,
                "language_flag": 'flags/{}.gif'.format(sub_language),
            ...
            log(__name__, '{} Subtitles found: {} (id = {}, language: {})'.format(debug_pretext, filename, file_id, language_name))

    except requests.exceptions.RequestException as e:
        log(__name__, 'Error fetching subtitles: {}'.format(e))
    ...
    try:
        ...
        for subtitle in data.get("data", []):
            ...
            subtitles_list.append({
                ...
                "sync": True,
                "id": file_id,
                "language_flag": 'flags/{}.gif'.format(sub_language),  # Use the actual subtitle language code
